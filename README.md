...
- The host supports LVGL `LV_COLOR_DEPTH=16` and `LV_COLOR_DEPTH=32`; 16-bit buffers are converted to the X11 window format during flush
...
- 当前支持 `LV_COLOR_DEPTH=16` 和 `LV_COLOR_DEPTH=32`；16-bit 像素缓冲会在 flush 时转换成 X11 窗口格式
